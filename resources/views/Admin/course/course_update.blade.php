...
@section('content1')
    <div class="app-main__outer">
        <div class="app-main__inner">
            ...
            <ul style="margin-left:160px" class="body-tabs body-tabs-layout tabs-animated body-tabs-animated nav">
                <li class="nav-item">
                    <a role="tab" class="nav-link active" id="tab-0" data-toggle="tab" href="#tab-content-0">
                        <span>Update {{ $course->namekh }}</span>
                    </a>
                </li>
            ...
            <div class="tab-content">
                <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
                    ...
                    <form action="admin/course/update/{{ $course->idkh }}" method="POST" enctype="multipart/form-data">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                        <div class="row">
                            <div style="margin-left:160px" class="col-md-6">
                                        ...
                                        <div>
                                            <div class="input-group">
                                                ...
                                                <input placeholder="name course" name="namekh" type="text"
                                                    value="{{ $course->namekh }}" class="form-control">
                                            </div>
                                            <br>
                                            <div class="input-group">
                            ...
                            <div style="margin-left:160px" class="col-md-6" style="margin-left:80px">
                                <div class="main-card mb-3 card">
                                    <div class="card-body">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select name="Category" id="Category" class="form-control">
                                                    @foreach ($category as $ca)
                                                        ...
                                                        <option
                                                        @if($course->level->category->idcategory == $ca->idcategory)
                                                            {{ "selected" }}
                                                        @endif
                                                        value="{{ $ca->idcategory }}">{{ $ca->namecategory }}
                                                        </option>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select name="Level" id="Level" class="form-control">
                                                    @foreach ($level as $lv)
                                                        ...
                                                        <option
                                                        @if($course->level->idlevel == $lv->idlevel)
                                                            {{ "selected" }}
                                                        @endif
                                                        value="{{ $lv->idlevel }}">{{ $lv->namelevel }}</option>
                                        ...
                                        <div>
                                            <div class="input-group">
                                                ...
                                                <textarea name="noidung" id="demo" class="form-control ckeditor"
                                                    rows="3">{{ $course->noidung }}</textarea>
                                            </div>
                                            <br>
                                            <div class="input-group">
                                                <br>
                                                <div class="input-group">
                                                    ...
                                                    <img width="200px"  src="Admin/update/{{ $course->hinh }}" alt="">
                                                    <br>
...
<ul style="margin-left:170px" class="body-tabs body-tabs-layout tabs-animated body-tabs-animated nav">
    <li class="nav-item">
        <a role="tab" class="nav-link active" id="tab-0" data-toggle="tab" href="#tab-content-0">
            <span>Bình luận {{ $course->namekh }}</span>
        </a>
    </li>
                        ...
                        <div class="table-wrapper">
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $cm->idcomment }}</td>
                                        <td>{{ $cm->account->name }}</td>
                                        <td>{{ $cm->content }}</td>

                                        <td>

                                            <a href="admin/comment/delete/{{ $cm->idcomment }}/{{ $course->idkh }}" class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE5C9;</i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
